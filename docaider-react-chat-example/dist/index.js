...
function useDocaiderChat(config) {
    ...
    // AI SDK chat hook
    const { messages, sendMessage, status, error, stop } = react.useChat({
...
function ChatWindow({ messages, isLoading, error, status, config, onClose, onSendMessage, onStop, }) {
    ...
    return (jsxRuntimeExports.jsxs(framerMotion.motion.div, Object.assign({ initial: { opacity: 0, y: 20, scale: 0.9 }, animate: { opacity: 1, y: 0, scale: 1 }, exit: { opacity: 0, y: 20, scale: 0.9 }, className: "bg-white rounded-lg shadow-lg mb-2 overflow-hidden flex flex-col", style: {
...
function ChatButton({ isOpen, config, onToggle }) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    return (jsxRuntimeExports.jsx(framerMotion.motion.div, Object.assign({ whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, className: "flex justify-end" }, { children: jsxRuntimeExports.jsx("button", Object.assign({ onClick: onToggle, className: `shadow-lg ${((_a = config.appearance) === null || _a === void 0 ? void 0 : _a.showButtonText)
            ...
            } }, { children: isOpen ? (jsxRuntimeExports.jsx(lucideReact.X, { className: "h-5 w-5" })) : (jsxRuntimeExports.jsxs("div", Object.assign({ className: "flex items-center gap-2" }, { children: [jsxRuntimeExports.jsx(lucideReact.MessageCircle, { className: "h-5 w-5" }), ((_j = config.appearance) === null || _j === void 0 ? void 0 : _j.showButtonText) && (jsxRuntimeExports.jsx("span", Object.assign({ className: "font-medium" }, { children: (_k = config.appearance) === null || _k === void 0 ? void 0 : _k.buttonText })))] }))) })) })));
}
...
function ChatWidget({ knowledgeBaseId, apiEndpoint = window.location.origin, position = "bottom-right", theme = {}, appearance = {}, behavior = {}, onOpen, onClose, onMessageSent, }) {
    ...
    return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `fixed ${positionClasses[position]} z-50` }, { children: [jsxRuntimeExports.jsx(framerMotion.AnimatePresence, { children: isOpen && (jsxRuntimeExports.jsx(ChatWindow, { messages: messages, isLoading: isLoading, error: error, status: status, config: config, onClose: handleClose, onSendMessage: handleSendMessage, onStop: stop })) }), jsxRuntimeExports.jsx(ChatButton, { isOpen: isOpen, config: config, onToggle: isOpen ? handleClose : handleOpen })] })));
}
...
exports.useDocaiderChat = useDocaiderChat;
